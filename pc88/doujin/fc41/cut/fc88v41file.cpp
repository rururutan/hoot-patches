// Firecracker Vol.42 (PC88) ファイル抽出プログラム
...
int main(int argc, char *argv[]) {
	...
	// ドライバ・ADPCM切り出し
	fcut("PMD",   38, 19, 0, 1, 1, 0, 0x2000);
	fcut("ADPCM",  1,  0, 1, 1, 1, 0, 0x14000);

	// ディレクトリの読み込み
	memset(dir, 0, sizeof(dir));
	if (disk.ReadDATA(0x27, 0x13, 0x01, 0x0f, 0x01, dir, sizeof(dir)) != sizeof(dir)) {
